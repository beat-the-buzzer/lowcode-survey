      ...
      <div class="table-tr" v-for="item in config.row" :key="item.id">
        ...
        <div class="table-td" v-for="c in config.children" :key="c.id">
          <el-radio
            :disabled="readOnly"
            size="large"
            v-model="checkedMap[item.id].checked"
            :label="c.id"
          ...
          >
            ...
            <el-input
              ...
              size="small"
              v-if="
                c.attribute.addInput && checkedMap[item.id].checked === c.id
              "
              v-model="checkedMap[item.id].input"
              @input="handleInput"
            ></el-input>
          </el-radio>
        </div>
      ...
      <div class="table-tr" v-for="item in config.children" :key="item.id">
        ...
        <div class="table-td" v-for="c in config.row" :key="c.id">
          <el-radio
            :disabled="readOnly"
            size="large"
            v-model="checkedMap[c.id].checked"
            :label="item.id"
            @change="handleRadioChange"
          >
            <span></span>
            <el-input
              ...
              size="small"
              v-if="
                item.attribute.addInput && checkedMap[c.id].checked === item.id
              "
              v-model="checkedMap[c.id].input"
              @input="handleInput"
            ></el-input>
          </el-radio>
        </div>
