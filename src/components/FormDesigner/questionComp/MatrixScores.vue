<template>
  <div>
    <div class="table">
      ...
      <div class="table-tr" v-for="(item, index) in data.row" :key="item.id">
        <div class="table-td">
          <InlineEditor
            v-model:modelValue="item.title"
        ...
        <div class="table-td" v-for="(col, i) in data.children" :key="col.id">
          <el-input-number
            v-model="num"
            :min="0"
            :max="data.attribute.maxScore"
...
const num = ref(props.data.attribute.maxScore);
