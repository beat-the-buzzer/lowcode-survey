    ...
    >
      <template #item="{ element, index }">
        <div
          ...
          :style="{ width: data.attribute.optionSpan ? 100 / data.attribute.optionSpan + '%' : 'initial' }"
...
import BatchAddOptions from "@/components/FormDesigner/components/BatchAddOptions.vue";
